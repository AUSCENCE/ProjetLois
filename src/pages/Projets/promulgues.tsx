...
import { getPromulgatedProjects, deleteProject } from "../../Api/project";
import BasicTableProjet from "../../components/tables/BasicTables/BasicTableProjet";
import { useNavigate } from "react-router";
import ConfirmDialog from "../../components/ui/ConfirmDialog";
import { useModal } from "../../hooks/useModal";

export default function ProjetsPromulgues() {
    ...
    const fetchProjet = async () => {
        try {
            const result = await getPromulgatedProjects();
    ...
    return (
        <>
            <PageMeta
                title="Projet lois | Projets Promulgués"
                description="Liste des projets de loi promulgués"
            />
            <PageBreadcrumb pageTitle="Projets Promulgués" />
            <div className="space-y-6">
                <ComponentCard
                    title="Liste des projets promulgués"
