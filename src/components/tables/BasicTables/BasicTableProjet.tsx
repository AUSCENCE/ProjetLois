...
export default function BasicTableProjet<T>({
  columns,
  data,
  defaultOnEdit,
  defaultOnDelete,
                    ...
                    >
                      {column.isActionColumn ? (
                        ...
                        (() => {
                          ...
                          if (column.accessorKey === 'filePath') {
                            ...
                            return (
                              <a
                                ...
                                className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-blue-600 bg-transparent rounded-lg hover:bg-blue-50 dark:text-blue-400 dark:hover:bg-white/[0.03]"
                              >
